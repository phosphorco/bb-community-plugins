// Offline-only declaration for the legacy DB-path probe.
import type {
  EXECUTION_LIMITS,
...
/** Test/probe only; it permits the legacy trusted database handoff. */
export function createProbeQueryRuntime(
