...
export function AgentationSettingsSection() {
  return (
    <div className="space-y-2 text-sm text-muted-foreground">
      ...
      <p>
        Agents read assigned feedback with the <code>agentation_mentions_*</code> tools or{" "}
        <code>bb agentation-mentions pending</code>. Resolving an annotation removes its marker from every
        open bb window.
      </p>
    </div>
  );
