...
```sh
npm run typecheck --workspace @phosphor/bb-plugin-bb-ui-reference
npm run test --workspace @phosphor/bb-plugin-bb-ui-reference
npm run build --workspace @phosphor/bb-plugin-bb-ui-reference
```
