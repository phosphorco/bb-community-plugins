...
| --- | --- | --- | --- |
| Cached | 31.0, 30.5, 31.2, 31.3, 31.1, 31.2, 31.1, 31.3, 31.6, 30.3, 31.1, 31.7 | 31.9, 30.9, 30.8, 30.9, 30.1, 32.1, 31.2, 31.4, 32.4, 31.1, 31.3, 31.5 | **32.4 / ≤45 atlas-regression ceiling / ≤50 interaction gate pass** |
...
to 81.7ms warm uncached. The witness now rejects values above 45ms/110ms,
respectively: variance-tolerant ceilings derived from the previous receipt and
still stricter than the 50ms/250ms interaction budgets.
